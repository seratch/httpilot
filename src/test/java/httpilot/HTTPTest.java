...
public class HTTPTest {
    ...
    public void post_A$Request_multipart() throws Exception {
        ...
        try {
            ...
            FormData entry1 = new FormData("toResponse", new TextInput("日本語", "UTF-8"));
            entry1.setContentType("text/plain");
            formDataList.add(entry1);
            FormData entry2 = new FormData("formData2", new TextInput("2222", "UTF-8"));
    ...
    public void post_A$Request_file() throws Exception {
        ...
        try {
            ...
            FormData entry2 = new FormData("gitignore", new FileInput(new File(".gitignore"), "text/plain"));
